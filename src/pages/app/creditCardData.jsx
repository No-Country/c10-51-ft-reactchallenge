                ...
                <View style={{ alignItems: 'center', marginTop: 20 }}>
                    ...
                    <View style={{ width: '85%', alignSelf: 'center' }}>
                        ...
                        <View style={{ alignSelf: 'center' }}>
                            ...
                            <TouchableOpacity onPress={goToPayActualizado} style={{ width: 150, backgroundColor: '#000', marginTop: 10, borderRadius: 10 }}>
                                <Text style={{ color: 'orange', padding: 10, textAlign: 'center', fontWeight: 900 }}>Guardar</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
